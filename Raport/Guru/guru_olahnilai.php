<?php
  ...
  $hasil = mysqli_query($koneksi, "SELECT * from MENGAJAR_GURU_SISWA where FK_ID_Guru = '$user' and Mata_Pelajaran = '$mapel'");
  ...
  function simpan(){
    //setelah edit dan hapus, simpan ke DB
  }
?>
...
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /><title>Tambah Nilai | SMA MTA Surakarta</title>
		...
		<script>
			$(document).ready(function(){
				var mapelo = $("#mapel").val();
				var url = 'guru_addnilai.php';
				data = {'action' : mapelo};
...
<body>
	...
	<div id="leftMain"> <a href="guru_profile.php"></a>
		<div id="navbar">
			<ul>
		...
		<div id="main">
			<div class="box-profile" style="margin-top:20px">
				<form action="guru_olahnilai.php" method="POST">
